...
def main():
    ...
    # args.joints = '21,28'  # 临时测试代码，指定多个关节
    # args.joints = '20,27'  # 临时测试代码，指定多个关节
    # args.joints = '19,26'  # 临时测试代码，指定多个关节
    ...
    # args.joints = '5,11'  # 临时测试代码，指定多个关节
    ...
    try:
        ...
        args.joints = '0,6'  # 临时测试代码，指定多个关节
        joint_indices = [int(idx) for idx in args.joints.split(',')]
        # for joint_idx in range(controller.config.num_joints):
        #     controller.joint_states[joint_idx].anim_state = ANIM_SEEK_LOWER
        #     controller.joint_states[joint_idx].target_position = config.cont_pos1[joint_idx]
